...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_devinfo_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_devinfo_2eproto[2];
...
const char descriptor_table_protodef_devinfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "POLLO3P\020\001B\002H\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_devinfo_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_devinfo_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_devinfo_2eproto = {
  false, false, descriptor_table_protodef_devinfo_2eproto, "devinfo.proto", 293,
  &descriptor_table_devinfo_2eproto_once, descriptor_table_devinfo_2eproto_sccs, descriptor_table_devinfo_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_devinfo_2eproto::offsets,
  file_level_metadata_devinfo_2eproto, 1, file_level_enum_descriptors_devinfo_2eproto, file_level_service_descriptors_devinfo_2eproto,
};
